...
const languageGreetings = {
  english: "Hi, I’m Saaya, your legal assistant. How can I help you today? Let me know if it’s urgent or if you need legal guidance.",

  hindi: "हाय, मैं साया, आपकी कानूनी सहायक हूँ। आज मैं आपकी कैसे मदद कर सकती हूँ? मुझे बताएं अगर यह जरूरी है या आपको कानूनी मार्गदर्शन चाहिए।",

  punjabi: "ਹਾਇ, ਮੈਂ ਸਾਯਾ, ਤੁਹਾਡੀ ਕਾਨੂੰਨੀ ਸਹਾਇਕ ਹਾਂ। ਅੱਜ ਮੈਂ ਤੁਹਾਡੀ ਕਿਵੇਂ ਮਦਦ ਕਰ ਸਕਦੀ ਹਾਂ? ਮੈਨੂੰ ਦੱਸੋ ਜੇ ਇਹ ਜ਼ਰੂਰੀ ਹੈ ਜਾਂ ਤੁਹਾਨੂੰ ਕਾਨੂੰਨੀ ਮਾਰਗਦਰਸ਼ਨ ਦੀ ਲੋੜ ਹੈ।",

  tamil: "ஹாய், நான் சாயா, உங்கள் சட்ட உதவியாளர். இன்று நான் உங்களுக்கு எப்படி உதவ முடியும்? அவசரமானது அல்லது சட்ட வழிகாட்டுதல் தேவைப்பட்டால் எனக்குத் தெரியப்படுத்துங்கள்.",

  marathi: "हाय, मी साया, तुमची कायदेशीर सहाय्यिका. आज मी तुम्हाला कशी मदत करू शकते? ते अगत्याचे आहे किंवा कायदेशीर मार्गदर्शन आवश्यक असल्यास मला कळवा.",

  telugu: "హాయ్, నేను సాయా, మీ లీగల్ అసిస్టెంట్. ఈరోజు నేను మీకు ఎలా సహాయం చేయగలను? అత్యవసరమైనది లేదా చట్టపరమైన మార్గదర్శన అవసరమైతే నాకు తెలియజేయండి.",

  bengali: "হাই, আমি সায়া, আপনার আইনি সহকারী। আজ আমি আপনাকে কিভাবে সাহায্য করতে পারি? আমাকে জানান যদি এটি জরুরি হয় বা আপনার আইনি নির্দেশনা প্রয়োজন।",

  kannada: "ಹಾಯ್, ನಾನು ಸಾಯಾ, ನಿಮ್ಮ ಕಾನೂನು ಸಹಾಯಕ. ಇಂದು ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಹುದು? ಅದು ತುರ್ತಾದಾಗ ಅಥವಾ ನೀವು ಕಾನೂನು ಮಾರ್ಗದರ್ಶನ ಬೇಕಾದರೆ ನನಗೆ ತಿಳಿಸಿ.",

  malayalam: "ഹായ്, ഞാൻ സായാ, നിങ്ങളുടെ നിയമ സഹായി. ഇന്ന് ഞാൻ നിങ്ങളെ എങ്ങനെ സഹായിക്കും? അത് അടിയന്തരമാണെങ്കിലോ നിങ്ങൾക്ക് നിയമ മാർഗ്ഗനിർദ്ദേശം ആവശ്യമാണെങ്കിലോ എന്നെ അറിയിക്കുക.",

  gujarati: "હાય, હું સાયા, તમારી કાનૂની સહાયક. આજે હું તમારી કેવી રીતે મદદ કરી શકું? જો તે અત્યાવશ્યક હોય અથવા તમને કાનૂની માર્ગદર્શન જોઈતું હોય તો મને જણાવો.",

  urdu: "ہائے، میں سایا، آپ کی قانونی معاون ہوں۔ آج میں آپ کی کیسے مدد کر سکتی ہوں؟ مجھے بتائیں اگر یہ فوری ہے یا آپ کو قانونی رہنمائی کی ضرورت ہے۔",

  odia: "ନମସ୍କାର, ମୁଁ ସାୟା, ଆପଣଙ୍କର ଆଇନଗତ ସହାୟକ। ଆଜି ମୁଁ ଆପଣଙ୍କୁ କିପରି ସହାୟତା କରିପାରିବି? ଯଦି ଏହା ଜରୁରୀ ଅଟେ କିମ୍ବା ଆପଣଙ୍କୁ ଆଇନଗତ ମାର୍ଗଦର୍ଶନ ଆବଶ୍ୟକ କରନ୍ତୁ ମୋତେ ଜଣାନ୍ତୁ।",

  bhojpuri: "हाय, हम साया हईं, आपके कानूनी सहायक। आज हम राउर कइसे मदद कर सकीले? बताईं जे जरूरी होखे या कानूनी सलाह के जरूरत होखे।",

  maithili: "नमस्कार, हम साया छी, अहाँक कानूनी सहायिका। आब हम अहाँक कहिन मदद कर सकैत छी? जँ अति जरूरी होय या कानूनी मार्गदर्शन के आवश्यकता होय तँ बताउ।",

  awadhi: "हाय, हम साया हईं, तोहार कानूनी सहायक। आज हम तोहार कइसन मदद कर सकीले? बताईं जे जरूरी हो या कानूनी सलाह के जरूरत हो।",

  bundeli: "हाय, हम साया, तोहार कानूनी सहायक। आज हम तोहार कइसन मदद कर सकीले? बताईं जे जरूरी हो या कानूनी सलाह के जरूरत हो।",

  haryanvi: "हाय, में साया, तेरी लीगल असिस्टेंट। आज में तेरे की मदद कर सकली सूं? बता दे अगर जरूरी हो या लीगल गाइडेंस चाही।",

  chhattisgarhi: "हाय, हम साया हवौं, तोहार लीगल असिस्टेंट। आज हम तोहार कइसन मदद कर सकीले? बताईं जे जरूरी हो या लीगल गाइडेंस चाही।",

  marwari: "हाय, हूं साया, थारी लीगल असिस्टेंट। आज हूं थारी कैसी मदद करू सकूं? बतावो जे जरूरी हो या लीगल गाइडेंस जोईए।",

  varhadi: "हाय, मी साया, तुमची लीगल असिस्टंट. आज मी तुमची कशी मदत करू शकते? सांगा जर ते अर्जंट असेल किंवा लीगल मार्गदर्शन हवं असेल.",

  tulu: "ಹಾಯ್, ನಾನ್ ಸಾಯಾ, ನಿನ್ನ ಲೀಗಲ್ ಅಸಿಸ್ಟೆಂಟ್. ಇನಿ ನಾನ್ ನಿನಗ್ ಎಂಚ ಸಹಾಯ ಮಲ್ಪೊಲಿ? ತೂರ್ ಜರೂರು ಆಂಡ್ ಲಾ ಗೈಡೆನ್ಸ್ ಬೋಡಾಂಡ್ ತೆರಿಯಾಂತ್.",

  konkani: "हाय, हांव साया, तुजो लीगल असिस्टेंट. आयज हांव तुका कशें मजत करूं शकता? सांग जर तें अर्जेंट आसल्यार वा लीगल मार्गदर्शन जाय आसल्यार.",

  dogri: "हाय, मैं साया, तेरी लीगल असिस्टेंट। आज मैं तेरी किस तरां मदद कर सकदी आं? दस्सो जे जरूरी होवे या लीगल गाइडेंस चाहीदी होवे।",

  manipuri: "ꯍꯥꯏ, ꯑꯩꯍꯥꯛꯅꯥ ꯁꯥꯌꯥ, ꯅꯍꯥꯛꯀꯤ ꯂꯤꯒꯦꯜ ꯑꯦꯁꯤꯁ꯭ꯇꯦꯟꯇ꯫ ꯉꯁꯤ ꯑꯩꯍꯥꯛꯅꯥ ꯅꯍꯥꯛꯄꯨ ꯀꯔꯝꯅꯥ ꯃꯇꯦꯡ ꯄꯥꯡꯕꯥ ꯌꯥꯕ꯭ꯔꯥ? ꯑꯩꯍꯥꯛꯄꯨ ꯇꯥꯕꯤꯌꯨ ꯀꯧꯕꯥ ꯃꯇꯝꯗꯥ ꯅꯠꯇ꯭ꯔꯒꯥ ꯂꯤꯒꯦꯜ ꯒꯥꯏꯗꯦꯟꯁꯀꯤ ꯃꯊꯧ ꯇꯥꯕꯥ ꯉꯝꯕꯥ ꯑꯣꯏꯔꯀꯏ꯫",

  nepali: "नमस्कार, म साया, तपाईंको कानूनी सहयोगी। आज म तपाईंलाई कसरी मद्दत गर्न सक्छु? मलाई थाहा दिनुहोस् यदि यो जरुरी छ वा तपाईंलाई कानूनी मार्गदर्शन चाहिन्छ भने।",

  assamese: "নমস্কাৰ, মই সায়া, আপোনাৰ আইনগত সহায়ক। আজি মই আপোনাক কেনেদৰে সহায় কৰিব পাৰো? মোক জনাওক যদি ইয়াৰ জৰুৰী বা আপুনি আইনগত পৰামৰ্শ বিচাৰে।",

  santali: "ᱦᱟᱭ, ᱤᱧ ᱥᱟᱭᱟ, ᱟᱢᱟᱜ ᱠᱟᱹᱱᱩᱱ ᱜᱚᱲᱚᱢ ᱦᱟᱯᱟᱴᱤᱭᱟᱹ᱾ ᱚᱱᱰᱮ ᱤᱧ ᱟᱢ ᱮᱢᱟᱱ ᱚᱠᱛᱮ ᱜᱚᱲᱚᱢ ᱫᱟᱲᱮᱭᱟᱜᱼᱟ? ᱤᱧ ᱮ ᱵᱟᱰᱟᱭ ᱢᱮ ᱡᱩᱫᱤ ᱱᱚᱶᱟ ᱟᱹᱰᱤ ᱜᱮᱭ ᱠᱟᱱᱟ ᱥᱮ ᱟᱢ ᱠᱟᱹᱱᱩᱱ ᱜᱚᱲᱚᱢ ᱞᱟᱹᱜᱤᱫ ᱮ ᱠᱷᱚᱡᱟ᱾",

  sindhi: "هاءِ، مان سايا، توهان جي قانوني مددگار. اڄ مان توهان جي ڪيئن مدد ڪري سگهان ٿو؟ مون کي ٻڌايو جيڪڏهن اهو ضروري آهي يا توهان کي قانوني رهنمائي جي ضرورت آهي.",

  bodo: "हाय, आं साया, नोंथांनि हेल्पारि। अन्दाइ आं नोंथांखौ माबोरै हेफाजाब होनो हागौ? आंखौ फोरमाय जुदि बेयारि जायो एबा नोंथांनि हेफाजाबनि गोनांथि जायो।",

  kashmiri: "ہیلو، میں سايا، تہٕندِ قانونی معاون۔ اَز کٔرِہ تہٕندِ کیٖفَہ مدد کٔرِ؟ مَنٛز چھِ یہِ ضروری یا تہٕندِ قانونی رہنمائی چھِ ضرورت۔",

  ladakhi: "जुलेख्! आँ साया, नगे लीगल असिस्टेंट। दीक आँ नगे कथुक मद्दत करुगो? बतायिख् यदि जरूरी हो या लीगल गाइडेंस चाहिए।",

  lepcha: "Namaste, I am Saaya from Chanakya AI. I'm your legal assistant. Could you tell me if you need legal help or if it's an emergency?",

  mizo: "Chibai! Ka hming Saaya, Chanakya AI atangin. Inlahrin ka theihnghilh thei che, engtin nge ka pui theih ang che?",

  mundari: "Johar! Ang Saaya kana, Chanakya AI se legal madad deta. Tum do kana kanoon ro sahay lagena?",

  bhili: "राम राम! में साया, चाणक्य एआई से आपरी लीगल सहायिका हूं। आज में आपरी काईसी मदद कर सकूं?",

  garo: "Khublei! Nga la Saaya, Chanakya AI na legal agent. Nangno dakani aidokani ma?",

  khasi: "Khublei, nga dei Saaya na Chanakya AI. Sngewbha ong kumno nga lah iarap ha ka bynta jong ka ain?",

  nagamese: "Namaskar! Moi Saaya ase Chanakya AI pora. Aaj moi apunar ki dhoronar legal help dibo parim?",

  kokborok: "Kwlwrwi! Ang Saaya, Chanakya AI borok a. Ang baijani nai: borok kobor dokai nai?"
};
